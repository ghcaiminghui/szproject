...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		...
		<a href="javascript:;" onclick="goods_add('添加商品','/goods/create','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a>
	</span> 
			...
			@foreach($data as $key=>$value)
				<tr class="text-c">
					...
					<td class="td-manage">
						<!--判断操作按钮 -->
						@if($value->status=='0')
							<a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe631;</i></a>
						@else
							<a style="text-decoration:none" onClick="admin_start(this,'10001')" href="javascript:;" title="上架"><i class="Hui-iconfont">&#xe615;</i></a>
						@endif
						<a title="编辑" href="javascript:;" onclick="admin_edit('商品编辑','/goods/{{$value->id}}/edit','{{$value->id}}','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_stop(obj,id){
    layer.confirm('确认要下架吗？',function(index)
	{
        ...
        $(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_start(this,id)" href="javascript:;" title="上架" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
...
function admin_start(obj,id)
{
    layer.confirm('确认要上架吗？',function(index)
    {
        ...
        $(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_stop(this,id)" href="javascript:;" title="下架" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');
