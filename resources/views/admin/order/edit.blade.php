...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-order-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商品订单号:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$value->order_no}}" placeholder="订单号" id="order_no" name="order_no">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<span class="select-box" style="width:150px;">
					<select class="select" name="shop_id" size="1">					
						<option value="{{$value->id}}">{{ $value->goods->name}}</option>
					</select>
				</span> 
			</div>
		</div>	
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$value->count}}" placeholder="" id="count" name="count">
			</div>
		</div>		
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<span class="select-box" style="width:110px;">
					<select class="select" name="country_id" size="1">
						<option value="">{{$value->country_id}}</option>	
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="详细地址" name="address" id="address" value="{{$value->address}}">
			</div>
		</div>
		{{csrf_field()}}
		<div class="row cl">
