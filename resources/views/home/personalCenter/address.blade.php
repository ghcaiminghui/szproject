...
@section('right')
				...
				<div class="user-content__box clearfix bgf">
					...
					<form action="/personal/address" class="user-addr__form form-horizontal" role="form" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input class="form-control" name="username" id="name" placeholder="请输入姓名" type="text">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input class="form-control" name="code" id="code" placeholder="请输入邮政编码" type="text">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-6">
								<div class="checkbox">
									<label><input type="checkbox" name="status" value="1"><i></i> 设为默认收货地址</label>
								</div>
							</div>
						</div>
						{{csrf_field()}}
